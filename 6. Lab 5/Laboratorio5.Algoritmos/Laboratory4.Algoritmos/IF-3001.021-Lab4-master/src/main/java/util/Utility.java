...
public class Utility {
    ...
    private static CircularDoublyLinkedList orderList;
    ...
    public static CircularDoublyLinkedList getOrderList() {
        return orderList;
    }

    public static void setOrderList(CircularDoublyLinkedList orderList) {
